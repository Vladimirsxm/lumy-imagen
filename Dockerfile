# --- bust cache si besoin ---
    ...
    # 3) ONNX + ONNXRUNTIME GPU (combo stable CUDA 12.1)
    RUN pip install onnx==1.16.0 onnxruntime-gpu==1.18.0
    
    # 4) OpenCV + InsightFace (laisse InsightFace ramener ses deps compatibles)
    ...
    # InsightFace: prépare les modèles au build (CPU)
